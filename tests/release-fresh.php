...
wpcb_release_assert(defined('WPCB_VERSION') && WPCB_VERSION === '3.19.10', 'Release ZIP boots version 3.19.10.');
...
// Keep this inside the existing required fresh_release gate, which the release
// job already needs. The helper creates and removes its own isolated CI database.
...
wpcb_release_assert(proc_close($process) === 0, 'Actual published 3.19.9 upgrades to the candidate without data loss.');
