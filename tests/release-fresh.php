...
wpcb_release_assert(defined('WPCB_VERSION') && WPCB_VERSION === '3.19.9', 'Release ZIP boots version 3.19.9.');
...
wpcb_release_assert(proc_close($process) === 0, 'Actual published 3.19.8 upgrades to the candidate without data loss.');
