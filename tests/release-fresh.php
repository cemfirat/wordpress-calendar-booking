...
wpcb_release_assert(defined('WPCB_VERSION') && WPCB_VERSION === '3.19.7', 'Release ZIP boots version 3.19.7.');
...
wpcb_release_assert(proc_close($process) === 0, 'Actual published 3.19.6 upgrades to the candidate without data loss.');
