...
- fail-closed detection for ambiguous local natural keys
- repeatably idempotent restore application without duplicate configuration relationships
- privacy-safe bounded conflict details before overwrite
