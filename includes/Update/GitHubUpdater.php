...
final class GitHubUpdater {
    ...
    public function checkUpdate($update, $pluginData, $pluginFile) {
    ...
    public function clearCacheAfterUpdate($upgrader, $options): void {
