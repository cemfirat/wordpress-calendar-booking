        ...
        switch ($action) {
            ...
            case 'save_type':
                ...
                $data = [
                    ...
                    'waiting_list_enabled' => empty($_POST['waiting_list_enabled']) ? 0 : 1,
                    'waiting_list_offer_minutes' => max(5, min(1440, absint($_POST['waiting_list_offer_minutes'] ?? 30))),
