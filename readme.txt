...
= 3.19.0 =
* Add privacy-safe configuration JSON export and validated restore with dry-run preview.
* Exclude bookings, customer data, tokens, payments, logs and credentials from configuration backups.
* Restore relationships with deterministic reference remapping and transactional rollback; calendar connections return disabled until credentials are re-entered.
