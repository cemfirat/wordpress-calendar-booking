...
= 3.14.0 =
* Let authenticated customers safely resume pending Stripe Checkout payments.
* Reuse open Stripe sessions and atomically replace expired sessions on the same payment record.
* Prevent settled or locally expired payments from starting another checkout.
